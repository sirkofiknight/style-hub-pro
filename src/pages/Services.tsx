...
const services = [
  ...
  },
  {
    ...
    description: "Make your special day unforgettable with bespoke wedding garments including kente designs for brides, grooms, and the entire wedding party.",
    features: ["Bridal gowns & suits", "Kente & traditional options", "Rush orders available", "On-site fitting service"],
  ...
  },
  {
    icon: Crown,
    title: "Agbada & Kaftan",
    description: "Elegant agbada and kaftan designs crafted exclusively for you, perfect for any occasion from ceremonies to casual events.",
    features: ["Custom design consultation", "Premium African fabrics", "Hand embroidery options", "Perfect fit guarantee"],
    price: "From GHS 1,800",
  },
  {
    icon: Sparkles,
    title: "Kente & Traditional Wear",
    description: "Authentic Ghanaian kente and traditional garments crafted with respect for cultural heritage and modern tailoring excellence.",
    features: ["Authentic kente weaving", "Hand embroidery options", "Family heritage pieces", "Ceremonial attire"],
